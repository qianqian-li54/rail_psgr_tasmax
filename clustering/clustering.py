...
# Output filenames
CLUSTERING_CEN_DAYS = '/data/cip19ql/rail_psgr_tasmax/data_output/clustering/clustering_cen_days_n15_re.pkl'
CLUSTERING_VIS = '/data/cip19ql/rail_psgr_tasmax/data_output/clustering/clustering_vis_n15_re.pkl'
...
def cluster_summer_days(date_range):
    ...
    kmeanModel = BisectingKMeans(n_clusters=N_CLUSTERS)
    kmeanModel.fit(X)
    # Labels of each point
    labels_x = kmeanModel.labels_
    # Coordinates of cluster centers / algebraic mean
    c_centers = kmeanModel.cluster_centers_
    ...
    for i in range(N_CLUSTERS):
        ...
        nearest_point_distance, nearest_point_index = kdt.query(c_centers[i])
